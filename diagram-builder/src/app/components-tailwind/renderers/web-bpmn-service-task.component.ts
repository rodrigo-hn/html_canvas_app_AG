...
@Component({
  selector: 'app-web-bpmn-service-task',
  standalone: true,
  ...
  template: `
    ...
    >
      @if (iconEnabled) {
      <div class="absolute text-[11px]" style="left: 6px; top: 4px;" [ngStyle]="iconStyle()">⚙️</div>
      }
...
export class WebBpmnServiceTaskComponent {
  @Input() text = 'Service Task';
